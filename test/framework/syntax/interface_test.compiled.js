        ...
        TestCase("InterfaceTestCase").prototype = {
            ...
            testSelf: function() {
                var MyIfc = window.MyIfc = function() {
                    var ifc = function() {};
                    ria.__API.ifc(ifc, "window.MyIfc", [ [ "method1", ifc, [], [] ], [ "method2", void 0, [ ifc ], [ "a" ] ], [ "getMyProp", ifc, [], [] ] ], []);
                    ifc.OF = ria.__API.OF;
                    return ifc;
                }();
            ...
            testProperties: function() {
                var MyIfc = window.MyIfc = function() {
                    var ifc = function() {};
                    ria.__API.ifc(ifc, "window.MyIfc", [ [ "getMyProp", Number, [], [] ], [ "setMyProp", void 0, [ Number ], [ "myProp" ] ], [ "isMyFlag", Boolean, [], [] ] ], []);
                    ifc.OF = ria.__API.OF;
                    return ifc;
                }();
            ...
            testImplements: function() {
                var BaseIfc = window.BaseIfc = function() {
                    var ifc = function() {};
                    ria.__API.ifc(ifc, "window.BaseIfc", [], []);
                    ifc.OF = ria.__API.OF;
                    return ifc;
                }();
                {};
            ...
            testMethodAnnotation: function() {
                var MyAnnotation = window.MyAnnotation = ria.__API.annotation("window.MyAnnotation", [], []);
                {};
                {};
            },
            testFlags: function() {
            ...
            testGenerics: function() {
                var MyIfc = window.IConverter = function() {
                    var TSource = ria.__API.getGeneralizedType("TSource", []), TReturn = ria.__API.getGeneralizedType("TReturn", []);
                    var ifc = function() {};
                    ria.__API.ifc(ifc, "window.IConverter", [ [ "convert", TReturn, [ TSource ], [ "source" ] ] ], [ TSource, TReturn ]);
                    ifc.OF = ria.__API.OF;
                    return ifc;
                }();
            ...
            testImplementsGeneric: function() {
                ...
                var Impl = window.Impl = function() {
                    ...
                    ria.__API.clazz(ClassCtor, "window.Impl", ria.__API.Class, [ MyIfc.OF(String, Number) ], [], false, [], []);
                ...
                var Impl2 = window.Impl = function() {
                    var $$ = ria.__API.init;
                    function ClassCtor() {
                        return $$(this, ClassCtor, _.$, [].slice.call(arguments));
                    }
                    ria.__API.clazz(ClassCtor, "window.Impl", ria.__API.Class, [ MyIfc ], [], false, [], []);
                    var _ = ClassCtor.prototype;
                    _.$ = function() {
                        ria.__API.Class.prototype.$.call(this);
                    };
