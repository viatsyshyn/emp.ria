    ...
    (function(ria) {
        ...
        TestCase("DelegateTestCase").prototype = {
            ...
            testBuildDelegate: function() {
                var Compare = window.Compare = function() {
                    var d = ria.__API.delegate("window.Compare", Boolean, [ String, String ], [ "_1", "_2" ], []);
                    d.OF = ria.__API.OF;
                    return d;
                }();
            ...
            testDelegateGenerics: function() {
                var delegate = window.map = function() {
                    var TKey = ria.__API.getGeneralizedType("TKey", []), TValue = ria.__API.getGeneralizedType("TValue", []);
                    var d = ria.__API.delegate("window.map", TValue, [ TKey, TValue ], [ "key", "value" ], [ TKey, TValue ]);
                    d.OF = ria.__API.OF;
                    return d;
                }();
